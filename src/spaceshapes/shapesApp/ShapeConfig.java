 ...
 * SpaceShape application's properties file, named spaceshapes.properties. This file
...
public class ShapeConfig {
	...
	private static final String FILE_NAME = "spaceshapes.properties";
	...
	/**
	 * Returns a reference to the ShapeConfig object.
	 */
	public static ShapeConfig instance() {
		if(instance == null) {
			instance = new ShapeConfig();
		}
		return instance;
	}
	
	/*
	 * Hidden constructor that populates the ShapeConfig instance with 
	 * property values. 
	 */
	private ShapeConfig() {
	...
	/**
	 * Main method to simply output the properties held by a ShapeConfig 
	 * object.
	 */
