...
import spaceshapes.forms.util.FormElementComponent;
import spaceshapes.forms.util.FormUtility;
import spaceshapes.shapesApp.ShapeConfig;
...
public class ShapeFormElement extends FormElementComponent {
	...
	private static final int MAX_WIDTH = ShapeConfig.instance().getAnimationBounds().width / 2;
	private static final int MIN_HEIGHT = 10;
	private static final int MAX_HEIGHT = ShapeConfig.instance().getAnimationBounds().height / 2;
