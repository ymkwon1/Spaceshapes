...
/** 
 * Test case to determine whether class SimpleImageShapeFormHandler has a 
 * satisfactory response time.
 * 
 * @author Ian Warren
 *
 */
public class TestSimpleImageShapeFormHandler {

	private FormHandler _handler;
	
	/**
	 * Creates an SimpleImageShapeFormHandler object for testing.
	 */
	@Before
	public void setUpHandler() {
		// To create an SimpleImageShapeFormHandler, a ShapeModel and a CarrierShape
		// are required.
		ShapeModel model = new ShapeModel(new Dimension(500,500));
		CarrierShape nest = new CarrierShape(0, 0, 1, 1, 100, 100);
		
		_handler = new SimpleImageShapeFormHandler(model, nest);
	}
		
	/**
	 * Tests that SimpleImageShapeFormHandler's processForm() method executes
	 ...
	 * attribute values. The SimpleImageShapeFormHandler under test uses the form to
	 ...
	 * the SimpleImageShapeFormHandler to load and scale. 
	 */
